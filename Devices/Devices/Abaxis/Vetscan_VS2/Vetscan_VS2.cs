...
namespace Devices.Abaxis
{
    ...
    [Serializable]
    public class Vetscan_VS2 : DevicesBase<Vetscan_VS2Config>
    {
        public Vetscan_VS2(string fileName)
            : base(fileName)
        {
            Protocol = new DRI_CHEM_NX500iVCProtocol.HTTPProtocol();
            Protocol.Init(this);
        }
        ...
        {
            UCVetscan_VS2Config uc = new UCVetscan_VS2Config(this);
        ...
        {
            Vetscan_VS2Config config = new Vetscan_VS2Config();
            config.Address = "192.168.1.100";
            config.LoginName = "pms";
            config.LoginPassword = "pms";
