...
namespace Devices.Huisong
{
    public class QR_1000 : DevicesBase<FF_6450Config>
    {
        public QR_1000(string fileName)
            : base(fileName)
        {
            //Protocol =null;
            //Protocol.Init(this);
        ...
        protected override DevicesInformation DefaultInfo()
        {
            DevicesInformation info = new DevicesInformation
            {
                ...
                Brand = "汇松(Huisong)",
                Model = "QR-1000",
                Name = "全自动特定蛋白分析仪 QR-1000",
                Remarks = "全自动特定蛋白分析仪",
                Code = "Huisong_QR-1000",
                Url = "http://www.huisong.com/ProductDetail/2896591.html",
            };
