...
{
    public class Pointcare_V2 : DevicesBase<FF_6450Config>
    {
        public Pointcare_V2(string fileName)
            : base(fileName)
        {
            //Protocol =null;
            //Protocol.Init(this);
        ...
        protected override DevicesInformation DefaultInfo()
        {
            DevicesInformation info = new DevicesInformation
            {
                ...
                Brand = "微纳芯(Mnchip)",
                Model = "Pointcare V2",
                Name = "动物专用全自动生化分析仪 Pointcare V2",
                Remarks = "动物专用全自动生化分析仪",
                Code = "Mnchip_Pointcare_V2",
                Url = "http://cn.mnchip.com/pointcare-v2/",
            };
